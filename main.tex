...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/MANOJ.wav
\end{lstlisting}
\item 
\label{Python code}
A Python Code is written to achieve Audio Filtering 
\lstinputlisting{./code/audio_filter.py}\label{prob:audio_filter_problem}
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/2.2.py
\end{lstlisting}
\begin{figure}[H]
  \centering
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/3.5.py
\end{lstlisting}
...
\end{align}
\begin{align}
  \left|H\brak{e^{j\brak{\omega + 2\pi}}}\right|
 &= \frac{4|\cos\brak{\omega + 2\pi}|}{\sqrt{5 + 4\cos\brak{\omega + 2\pi}}} \\
 &= \frac{4|\cos{\omega}|}{\sqrt{5 + 4\cos{\omega}}} \\
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/MANOJ5912/EE1205_Audio-filter/blob/main/code/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
